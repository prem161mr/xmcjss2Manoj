...
const Product = ({ fields: _fields }: ProductsProps): JSX.Element => {
    ...
    <section className="bg-white text-center py-5 container">
      ...
      <div className="row mt-3">
        {products.map((p, index) => (
          <div key={p.id || index} className="col-lg-4 col-md-6" style={{ padding: '26px' }}>
            <div className="card h-100 shadow-sm border-0 overflow-hidden">
              <div className="position-relative">
                <img src={p.image} className="card-img-top" height={400} alt="Headphones" />
